...
[DEFAULT_MAP] = {
  ...
  {KC_LCTL, KC_LGUI, KC_LALT, XXXXXXX, CK_RAS,  KC_SPC,  KC_SPC,  CK_LOW,  CK_DNUM, KC_RALT, KC_RGUI, KC_RCTL}
},
[LOWER_MAP] = {
...
[DEFAULT_NUMPAD_MAP] = {
  {_______, _______, _______, _______, _______, _______, _______, KC_NLCK, KC_P7,   KC_P8,   KC_P9,   _______},
  {_______, _______, KC_PAST, KC_PPLS, _______, _______, _______, KC_PDOT, KC_P4,   KC_P5,   KC_P6,   _______},
  {_______, _______, KC_PSLS, KC_PMNS, _______, _______, _______, KC_P0,   KC_P1,   KC_P2,   KC_P3,   _______},
  {_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______}
},
...
[ADJUST_MAP] = {
  ...
  {_______, _______, _______, _______, _______, _______, _______, MI_ON,   MI_OFF,  _______, _______, _______},
  {_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______}
}
};
